...
class Exercise2 {
    ...
    void personHasNotEmptyLastNameAndFirstName() {
        ...
        Predicate<Person> validate = x -> !x.getFirstName().isEmpty() && !x.getLastName().isEmpty();
    ...
    void personHasNotEmptyLastNameAndFirstNameUsingLogicalOperators() {
        Predicate<Person> personHasEmptyFirstName = x -> x.getFirstName().isEmpty();
        Predicate<Person> personHasEmptyLastName = x -> x.getLastName().isEmpty();
